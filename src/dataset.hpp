...
public:
    ...
    void summary(Bitmask const & capture_set, float & info, float & max_cost_reduction, float & min_loss, float & max_loss, unsigned int & target_index, unsigned int id) const;
